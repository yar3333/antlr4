...
use Antlr4\PrecedencePredicate; //('./SemanticContext').PrecedencePredicate;
...
/* Transition */const EPSILON =/ 1;
Transition::RANGE = 2;
Transition::RULE = 3;
Transition::PREDICATE = 4;// e.g., {isType(input.LT(1))}?
/* Transition */const ATOM =/ 5;
Transition::ACTION = 6;
Transition::SET = 7;// ~(A|B) or ~atom, wildcard, which convert to next 2
/* Transition */const NOT_SET =/ 8;
...
/* AtomTransition */function matches( $symbol, $minVocabSymbol,  $maxVocabSymbol) 
{
...
/* RuleTransition */function matches($symbol, $minVocabSymbol,  $maxVocabSymbol) 
{
	return false;
};
...
/* EpsilonTransition */function matches( $symbol, $minVocabSymbol,  $maxVocabSymbol) 
{
	return false;
};
...
/* SetTransition */function matches($symbol, $minVocabSymbol,  $maxVocabSymbol) 
{
...
/* NotSetTransition */function matches($symbol, $minVocabSymbol,  $maxVocabSymbol) 
{
...
/* WildcardTransition */function matches($symbol, $minVocabSymbol,  $maxVocabSymbol) 
{
	return $symbol >= $minVocabSymbol && $symbol <= $maxVocabSymbol;
};
...
/* PrecedencePredicateTransition */function matches($symbol, $minVocabSymbol,  $maxVocabSymbol) 
{
	return false;
};

/* PrecedencePredicateTransition */function getPredicate() 
{
