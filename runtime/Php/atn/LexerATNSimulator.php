...
use Antlr4\LexerATNConfig; //('./ATNConfig').LexerATNConfig;
use Antlr4\Transition; //('./Transition').Transition;
use Antlr4\LexerActionExecutor; //('./LexerActionExecutor').LexerActionExecutor;
...
/* LexerATNSimulator */function copyState($simulator) 
{
...
/* LexerATNSimulator */function match($input, $mode) 
{
	$this->match_calls += 1;
	$this->mode = $mode;
	/*var */$mark = $input->mark();
...
/* LexerATNSimulator */function reset() 
{
	$this->prevAccept->reset();
	$this->startIndex = -1;
	$this->line = 1;
...
/* LexerATNSimulator */function execATN($input, $ds0) 
{
	if (LexerATNSimulator::debug) 
	{
...
// already cached
/* LexerATNSimulator */function getExistingTargetState($s, $t) 
{
...
/* LexerATNSimulator */function failOrAccept($prevAccept, $input, $reach, $t) 
{
...
// parameter.
/* LexerATNSimulator */function getReachableConfigSet($input, $closure,
		$reach, $t) 
...
/* LexerATNSimulator */function accept($input, $lexerActionExecutor,
...
/* LexerATNSimulator */function getReachableTarget($trans, $t) 
{
...
// {@code true}.
// /
/* LexerATNSimulator */function evaluatePredicate($input, $ruleIndex,
...
/* LexerATNSimulator */function captureSimState($settings, $input, $dfaState) 
{
...
/* LexerATNSimulator */function getDFA($mode) 
{
	return $this->decisionToDFA[$mode];
};

// Get the text matched so far for the current token.
/* LexerATNSimulator */function getText($input) 
...
/* LexerATNSimulator */function getTokenName($tt) 
{
	if ($tt === -1) 
	{
		return "EOF";
