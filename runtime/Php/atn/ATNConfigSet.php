...
/* ATNConfigSet */function optimizeConfigs($interpreter) 
{
	if ($this->readOnly) 
	{
		throw "This set is readonly";
...
/* ATNConfigSet */function addAll($coll) 
{
...
/* ATNConfigSet */function equals($other) 
{
	return $this === $other ||
...
/* ATNConfigSet */function updateHashCode($hash) 
{
	if ($this->readOnly) 
	{
...
/* ATNConfigSet */function isEmpty() 
{
	return $this->configs->length === 0;
};

/* ATNConfigSet */function contains($item) 
{
...
/* ATNConfigSet */function containsFast($item) 
{
	if ($this->configLookup === null) 
	{
		throw "This method is not implemented for readonly sets.";
...
/* ATNConfigSet */function setReadonly($readOnly) 
{
