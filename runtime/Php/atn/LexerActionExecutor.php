...
static function /* 
 */LexerActionExecutor($lexerActionExecutor, $lexerAction) 
{
...
/* LexerActionExecutor */function hashCode() 
{
	return $this->cachedHashCode;
};

/* LexerActionExecutor */function updateHashCode($hash) 
{
    $hash->update($this->cachedHashCode);
};


/* LexerActionExecutor */function equals($other) 
{
	if ($this === $other) 
	{
		return true;
